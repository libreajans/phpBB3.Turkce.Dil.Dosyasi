...
$lang = array_merge($lang, array(
	...
	'BBCODE_O_HELP'				=> 'Sıralı liste: [list=1][*]1. madde[/list] veya [list=a][*]a maddesi[/list]',
	...
	'POST_REVIEW_EDIT'			=> 'İleti önizleme',
	'POST_REVIEW_EDIT_EXPLAIN'	=> 'Bu ileti siz düzenleme yaparken başka bir kullanıcı tarafından değiştirildi. İletinin güncel halini gözden geçirip düzenlemelerinizi ayarlamak isteyebilirsiniz.',
	...
	'SAVE_DRAFT_CONFIRM'		=> 'Lütfen dikkat, taslaklar sadece ileti konusu ve ileti içeriğini kaydeder, diğer elemanlar silinecektir. Taslağı şimdi kaydetmek istiyor musunuz?',
	'SMILIES'					=> 'İfadeler',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Süresiz Sabit/Duyuru için 0 yazın veya boş bırakın. Lütfen bu numaranın ileti tarihine göre etkili olduğunu göz önüne alın.',
	'STYLES_TIP'				=> 'İpucu: Biçimleri hızlı uygulamak için metinleri seçebilirsiniz.',

	'TOO_FEW_CHARS'				=> 'İletiniz çok az karakter içeriyor.',
	'TOO_FEW_CHARS_LIMIT'		=> 'İletiniz %1$d karakter içeriyor. Kullanmanız gerekli minimum karaketer sayısı ise %2$d.',
