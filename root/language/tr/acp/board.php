...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'	=> 'Burada görsel doğrulamanın varsayılan ve CAPTCHA ayarlarını belirleyebilirsiniz.',

	'CAPTCHA_GD'							=> 'GD CAPTCHA',
	'CAPTCHA_GD_FOREGROUND_NOISE'			=> 'GD CAPTCHA arkaplan uygulaması',
	'CAPTCHA_GD_EXPLAIN'					=> 'Daha gelişmiş bir CAPTCHA yapmak için GD kullanın.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> 'CAPTCHA’yı güçlendirmek için GD uygulamasını kullanır.',
	'CAPTCHA_GD_X_GRID'						=> 'GD CAPTCHA arkaplan uygulaması x-ekseni',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'GD tabanlı CAPTCHA’yı güçlendirmek için bu ayarları düşük seviyede kullanın. 0 x-eksenli arkaplan uygulamasını kısık hale getirecektir.',
