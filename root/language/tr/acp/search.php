...
$lang = array_merge($lang, array(
	...
	'CONFIRM_SEARCH_BACKEND'				=> 'Arama sonuçlarını farklı bir sisteme değiştirmek istediğinze emin misiniz? Arama sistemini değiştirdikten sonra yeni sistem için, bir arama indexi oluşturmanız gerekecek. Eğer eski arama sistemine dönmeyi planlamıyorsanız, sistem kaynaklarınızı boşaltmak için eski arama indexlerini silebilirsiniz.',
	...
	'FULLTEXT_MYSQL_INCOMPATIBLE_VERSION'	=> 'MySQL tam metin indekslemesi sadece MySQL4 ve üzeri ile kullanılabilir.',
	'FULLTEXT_MYSQL_NOT_MYISAM'				=> 'MySQL tam metin indekslemesi sadece MyISAM tablolar ile kullanılabilir.',
...
'SEARCH_GUEST_INTERVAL'					=> 'Misafir kullanıcı arama flood aralığı', // Flood için tercüme ?
	...
	'SEARCH_INDEX_CREATE_REDIRECT'			=> '%1$d numaralı iletiye kadar olan tüm iletiler indeksendi. Bu aşamada %2$d ileti vardı.<br />Şu andaki indexleme oranı saniye başına yaklaşık %3$.1f iletidir. <br />İndexleme sürüyor…',
...
'SEARCH_INTERVAL'						=> 'Kullanıcı arama flood aralığı', // Flood için tercüme ?
	...
	'SEARCH_TYPE_EXPLAIN'					=> 'phpBB ileti içeriğindeki yazıyı ararken kullanılacak sisteminizi kendinizin seçmesine olanak tanır. Varsayılan olarak phpBB’nin tümyazıyı arama özelliği kullanılır.',
	...
	'YES_SEARCH_UPDATE'						=> 'Metin güncellemesini aç',
	'YES_SEARCH_UPDATE_EXPLAIN'				=> 'Her ileti gönderildiğinde arama indeksini günceller. Eğer arama özelliği kapalıysa güncelleme yapılmaz.',
));
