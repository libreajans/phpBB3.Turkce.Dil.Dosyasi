...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_LOCAL_F_'		=> '<strong>Kullanıcıların pano erişimleri eklendi ya da düzenlendi</strong> buradan: %1$s<br />» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'		=> '<strong>Kullanıcıların forum yetkili erişimleri, eklendi ya da düzenlendi</strong> buradan: %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_'	=> '<strong>Grupların forum erişimleri, eklendi ya da düzenlendi</strong> buradan: %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_'	=> '<strong>Grupların forum yetkili erişimleri, eklendi ya da düzenlendi</strong> buradan: %1$s<br />» %2$s',

	'LOG_ACL_ADD_MOD_LOCAL_M_'		=> '<strong>Yetkililer eklendi ya da düzenlendi</strong> buradan: %1$s<br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'	=> '<strong>Forum izinleri eklendi ya da düzenlendi</strong> buradan: %1$s<br />» %2$s',
	...
	'LOG_ACL_DEL_MOD_LOCAL_M_'		=> '<strong>Yetkililer silindi</strong> buradan: %1$s<br />» %2$s',
	'LOG_ACL_DEL_FORUM_LOCAL_F_'	=> '<strong>Kullanıcı grup forum izinleri iptal edildi</strong> buradan: %1$s<br />» %2$s',
	...
	'LOG_FORK'					=> '<strong>Konu kopyalandı</strong><br />» %s konusundan',
	...
	'LOG_MOVE'					=> '<strong>Konu taşındı</strong><br />» %1$s -> %2$s',
	...
	'LOG_POST_DISAPPROVED'		=> '<strong>“%1$s”, ileti aşağıdaki nedenden dolayı red edildi</strong><br />» %2$s',
	'LOG_POST_EDITED'			=> '<strong>“%1$s”, ileti düzenlendi, yazarı</strong><br />» %2$s',
	'LOG_REPORT_CLOSED'			=> '<strong>Rapor kapatıldı</strong><br />» %s',
	'LOG_REPORT_DELETED'		=> '<strong>Rapor silindi</strong><br />» %s',
	'LOG_SPLIT_DESTINATION'		=> '<strong>Bölünen iletiler taşındı</strong><br />» şuraya: %s',
	'LOG_SPLIT_SOURCE'			=> '<strong>İleti bölündü</strong><br />» %s konusundan',

	'LOG_TOPIC_APPROVED'		=> '<strong>Konu onaylandı</strong><br />» %s',
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>“%1$s”, konu aşağıdaki nedenden dolayı red edildi</strong><br />%2$s',
	...
	'LOG_USER_MOVE_POSTS'	=> '<strong>Kullanıcı iletileri taşındı</strong><br />» ileti yazarı: “%1$s”, “%2$s” forumuna',
	...
	'LOG_USER_UPDATE_EMAIL'	=> '<strong>Kullanıcı “%1$s” e-posta adresi değiştirildi</strong><br />» “%2$s” -> “%3$s”',
	'LOG_USER_UPDATE_NAME'	=> '<strong>kullanıcı adı değiştirildi</strong><br />» “%1$s” -> “%2$s”',
