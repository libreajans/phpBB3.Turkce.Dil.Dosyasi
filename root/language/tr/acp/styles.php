...
$lang = array_merge($lang, array(
	...
	'ADD_STYLE'				=> 'Biçim oluştur',
	'ADD_STYLE_EXPLAIN' 	=> 'Buradan yeni bir biçim oluşturabilirsiniz. sunucu yapılandırılması ve dosya izinlerine bağlı olarak burada ek tercihler görebilirsiniz. Dilerseniz, buraya bir biçim arşivi ithal edebilir veya yükleyebilirsiniz. Eğer bir arşivi yüklemeyi veya ithal etmeyi seçerseniz, biçim ismi opsiyonel olarak arşiv isminden atanabilir (Bunun gerçekleşmesi için tema ismini boş bırakmanız yeterlidir).',
	...
	'DELETE_STYLE'				=> 'Biçimi sil',
	'DELETE_STYLE_EXPLAIN' 		=> 'Seçilmiş biçimi buradan kaldırabilirsiniz. Biçimleri silerken dikkat ediniz zira bu durumun geri dönüşü mümkün değildir.',
	...
	'EDIT_DETAILS_STYLE'				=> 'Biçimi değiştir',
	'EDIT_DETAILS_STYLE_EXPLAIN' 		=> 'Aşağıdaki form aracılığı ile şu anki biçimi düzenleyebilir, şablonun, temanın, resim setinin birleşiminde değişiklik yapabilirsiniz. Ayrıca, biçimi varsayılan olarak atayabilirsiniz.',
	...
	'EDIT_THEME_STORED_DB' 				=> 'Biçim belgesi yazılamaz niteliktedir, o yüzden yapmış olduğunuz değişiklikler ile birlikte, biçim belgesi şu an veritabanına kaydedilmiştir.',
	...
	'IMG_CAT_BUTTONS'		=> 'Yerelleşmiş butonlar',
	...
	'IMG_CAT_POLLS'			=> 'Anket resimleri',
	'IMG_CAT_UI'			=> 'Genel kullanıcı arayüzü öğeleri',
	'IMG_CAT_USER'			=> 'İlave resimler',

	'IMG_SITE_LOGO'			=> 'Ana logo',
	'IMG_UPLOAD_BAR'		=> 'Yükleme ilerleme çubuğu',
	'IMG_POLL_LEFT'			=> 'Anket sol bitimi',
	...
	'IMG_FORUM_UNREAD'			=> 'Forum okunmamış iletiler',
	'IMG_FORUM_UNREAD_LOCKED'	=> 'Forum okunmamış iletiler kilitli',
	'IMG_FORUM_UNREAD_SUBFORUM'	=> 'Alt forum okunmamış iletiler',
	'IMG_SUBFORUM_READ'			=> 'Açıklama alt forumu',
	'IMG_SUBFORUM_UNREAD'		=> 'Açıklama alt forumu okunmamış ileti',
	...
	'IMG_TOPIC_UNREAD'				=> 'Konu okunmamış iletiler',
	'IMG_TOPIC_UNREAD_MINE'			=> 'Konu gönderildiğinde',
	'IMG_TOPIC_UNREAD_HOT'			=> 'Konu popüler okunmamış iletiler',
	'IMG_TOPIC_UNREAD_HOT_MINE'		=> 'Konu popüler gönderildiğinde',
	'IMG_TOPIC_UNREAD_LOCKED'		=> 'Konu kilitli okunmamış',
	'IMG_TOPIC_UNREAD_LOCKED_MINE'	=> 'Konu kilitli okunmamış gönderildiğinde',
	...
	'IMG_STICKY_UNREAD'				=> 'Sabit konu okunmamış gönderildiğinde',
	'IMG_STICKY_UNREAD_MINE'		=> 'Sabit konu gönderildiğinde',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'Sabit konu kilitli okunmamış gönderildiğinde',
	...
	'IMG_ANNOUNCE_UNREAD'				=> 'Duyuru okunmamış gönderildiğinde',
	'IMG_ANNOUNCE_UNREAD_MINE'			=> 'Duyuru gönderildiğinde',
	'IMG_ANNOUNCE_UNREAD_LOCKED'		=> 'Duyuru kilitli okunmamış gönderildiğinde',
	...
	'IMG_GLOBAL_UNREAD'					=> 'Genel okunmamış iletiler',
	'IMG_GLOBAL_UNREAD_MINE'			=> 'Genel okunmamış gönderildiğinde',
	'IMG_GLOBAL_UNREAD_LOCKED'			=> 'Genel kilitli okunmamış iletiler',
	'IMG_GLOBAL_UNREAD_LOCKED_MINE'		=> 'Genel kilitli okunmamış gönderildiğinde',
	...
	'INACTIVE_STYLES'			=> 'Pasif biçimler',
	...
	'INSTALL_STYLE'				=> 'Biçim yükle',
	'INSTALL_STYLE_EXPLAIN' 	=> 'Buradaki menü aracılığı ile yeni bir biçim yükleyebilirsiniz. Eğer daha önceden ilintili yüklü biçim öğeleriniz var ise, üzerlerine yazılmayacaktır. Bazı biçimler için mevcut biçim öğelerinin önceden yüklenmiş olması gerekir. Eğer bir biçim yüklemeye çalışıyorsanız ve gerekli öğelere sahip değil iseniz, sistem tarafından uyarılırsınız.',
	...
	'INSTALLED_STYLE'			=> 'Kurulu biçimler',
	...
	'NO_UNINSTALLED_STYLE'		=> 'Kurulu olmayan biçimler algılanmadı.',
	...
	'ONLY_STYLE'			=> 'Kalan tek biçimi silemezsiniz.',
	...
	'REPLACE_STYLE'				=> 'Biçimin üzerine yaz',
	'REPLACE_STYLE_EXPLAIN'		=> 'Bu biçim üzerine yazdığınızı silerek yerini alacaktır.',
	...
	'REQUIRES_IMAGESET'			=> 'Bu biçimin kurulumu için %s resim seti yüklü olması gerekiyor.',
	'REQUIRES_TEMPLATE'			=> 'Bu biçimin kurulumu için %s şablonun yüklü olması gerekiyor.',
	'REQUIRES_THEME'			=> 'Bu biçimin kurulumu için %s tamanın yüklü olması gerekiyor.',
	...
	'STYLE_ACTIVE'				=> 'Aktif',
	'STYLE_ADDED'				=> 'Biçim eklendi.',
	'STYLE_DEACTIVATE'			=> 'Pasifleştir',
	'STYLE_DEFAULT'				=> 'Varsayılan biçim yap',
	'STYLE_DELETED'				=> 'Biçim silindi.',
	'STYLE_DETAILS_UPDATED'		=> 'Biçim değiştirildi.',
	'STYLE_ERR_ARCHIVE'			=> 'Lütfen bir arşiv metodu seçiniz.',
	'STYLE_ERR_COPY_LONG'		=> 'Telif bilgisi 60 karakterden uzun olamaz.',
	'STYLE_ERR_MORE_ELEMENTS'	=> 'En az bir biçim elemanı seçmelisiniz.',
	'STYLE_ERR_NAME_CHARS'		=> 'Biçim adı sadece harf ve rakamlar içerebilir, -, +, _ ve boşluk',
	'STYLE_ERR_NAME_EXIST'		=> 'Bu isimde bir biçim zaten mevcut.',
	'STYLE_ERR_NAME_LONG'		=> 'Biçim adı 30 karakterden uzun olamaz.',
	'STYLE_ERR_NO_IDS'			=> 'Bu biçim için, bir şablon, tema ve resim seti seçmek zorundasınız.',
	'STYLE_ERR_NOT_STYLE'		=> 'Yüklenen veya ihraç edilmiş dosya geçerli bir arşiv biçimi içermiyor.',
	'STYLE_ERR_STYLE_NAME'		=> 'Bu biçim için bir isim yazmalısınız.',
	'STYLE_EXPORT'				=> 'Biçim ihraç et',
	'STYLE_EXPORT_EXPLAIN'		=> 'Burada form içindeki bir biçim arşivini dışarı aktarabilirsiniz. Bir biçim, tüm elemanlarını kapsamayabilir ama en az bir elemanı olmalıdır. Örneğin yeni bir tema oluştursak ve görüntü seti kullandığınız bir şablon ise, temayı dışarı aktarabilirsiniz. Bu dosyayı daha sonra FTP dizinize göndermek için indirebilir veya kendi saklama dizininize bu dosyayı yollayabilirsiniz.',
	'STYLE_EXPORTED'			=> 'Biçim ihraç edildi ve %s dizininde depolandı',
	'STYLE_IMAGESET'			=> 'Resim seti',
	'STYLE_NAME'				=> 'Biçim adı',
	'STYLE_TEMPLATE'			=> 'Şablon',
	'STYLE_THEME'				=> 'Tema',
	'STYLE_USED_BY'				=> 'Kullanım (botlar dahil)',
	...
	'TEMPLATE_EDITOR'			=> 'Ham HTML şablonu',
	'TEMPLATE_EDITOR_HEIGHT'	=> 'Şablon editörü yüksekliği',
	'TEMPLATE_ERR_ARCHIVE'		=> 'Lütfen bir arşiv metodu seçiniz.',
	'TEMPLATE_ERR_CACHE_READ'	=> 'Önbellek dizini açılamayan şablon dosyalarının önbellek sürümünün depolanması için kullanılır.',
	...
	'TEMPLATE_LOCATION'			=> 'Şablonu depola',
	...
	'THEME_LOCATION'			=> 'Biçim belgesini depola',
	...
	'UNINSTALLED_STYLE'		=> 'Kurulu olmayan biçimler',
