...
$lang = array_merge($lang, array(
	...
	'ATTACH_ID'							=> 'ID',
	'ATTACH_MAX_FILESIZE'				=> 'Maksimum ileti eki büyüklüğü',
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'Her bir dosya için maksimum boyut, sınır koymamak için 0 değerini yazın.',
	'ATTACH_MAX_PM_FILESIZE'			=> 'Maksimum özel mesaj eki büyüklüğü',
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Her bir özel mesaj eki için ayrılacak maksimum boyut, sınır koymamak için 0 değerini yazın.',
	'ATTACH_ORPHAN_URL'					=> 'İlişiksiz eklentiler',
	'ATTACH_POST_ID'					=> 'İleti ID',
	'ATTACH_QUOTA'						=> 'Toplam mesaj eki kotası',
	'ATTACH_QUOTA_EXPLAIN'				=> 'Panoda izin verilen toplam mesaj eki için ayrılan alan.<br>Sınırsız için 0 değerini yazın.',
	...
	'MAX_ATTACHMENTS'				=> 'Her bir ileti için maksimum eklenti sayısı',
	'MAX_ATTACHMENTS_PM'			=> 'Her bir özel mesaj için maksimum eklenti sayısı',
	'MAX_EXTGROUP_FILESIZE'			=> 'Maksimum dosya boyutu',
	'MAX_IMAGE_SIZE'				=> 'Maksimum resim ebatları',
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'İleti eki maksimum resim boyutları. Ebat kontrolünü kapatmak için, her iki değere de 0 değerini girmelisiniz.',
	'MAX_THUMB_WIDTH'				=> 'Maksimum önizleme resmi genişliği (px)',
	'MAX_THUMB_WIDTH_EXPLAIN'		=> 'Üretilen önizleme resmi, bu değeri geçemeyecek',
	'MIN_THUMB_FILESIZE'			=> 'Minimum önizleme resmin dosya boyutu',
