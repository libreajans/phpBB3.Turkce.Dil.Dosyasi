...
$lang = array_merge($lang, array(
	...
	'COLLIDING_USERNAMES_FOUND'	=> 'Eski panonuzla çatışan isimler bulundu. Dönüştürme işleminin tamamlanması için lütfen bu kullanıcıları yeniden adlandırın veya silin. Böylece her kullanıcı adı için sadece bir temiz kullanıcı adı tanımlı olacaktır.',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Panonuzu phpBB3’e dönüştürdünüz. Giriş yaparak <a href="../">panonuza ulaşabilirsiniz</a>. Lütfen tüm ayarların ve bilgilerin doğru transfer edildiğini kontrol ettikten sonra install dizinini silerek panonuzu erişime açınız. phpBB kullanımı hakkında yardım için çevrimiçi <a href="https://www.phpbb.com/support/documentation/3.0/">belgeler (İngilizce)</a> ve Türkçe <a href="http://phpbbturkiye.net/phpbb3-f4/">yardım forumları</a> bulunduğunu unutmayınız.',
	'CONVERT_INTRO'				=> 'phpBB’nin birleşmiş yapı dönüştürücüsüne hoşgeldiniz',
	'CONVERT_INTRO_BODY' 		=> 'Buradan diğer yüklenmiş pano sistemlerinden veri transferinde bulunabilirsiniz. Aşağıdaki liste size şu an için desteklenen dönüştürme modüllerini göstermektedir. Eğer aradığınız dönüştürme modülünü bu listede bulamıyorsanız, lütfen phpbb resmi web sitesini ziyaret ederek aradığınız dönüştürücünün indirme listemize dahil edilip edilmediğini kontrol ediniz.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>phpBB %1$s kurulumunu tamamladınız. Devam etmek için aşağıdaki seçeneklerden birini seçiniz:</p>
		...
		<p>Aşağıdaki butona basarak Yönetim Paneli’ne gidebilir ve eğer isterseniz phpBB istatistik verilerini gönderebilirsiniz. Bu bilgileri göndererek phpBB’nin gelişimine katkıda bulunabilirsiniz. Daha sonra, neler yapabileceğinizi öğrenmek için biraz zaman ayırıp yönetim panelini inceleyin. <a href="https://www.phpbb.com/support/documentation/3.0/">Belgeler (ingilizce)</a> ve Türkçe <a href="http://phpbbturkiye.net/phpbb3-f4/">destek forumları</a> kısımlarında çevrimiçi yardım bulunduğunu unutmayın, daha fazla bilgi için <a href="%3$s">beni oku</a> dosyasını inceleyin.</p><p><strong>Lütfen şimdi install dizininin ismini değiştirin, silin veya taşıyın. Eğer dizin bulunuyorsa, sadece Yönetim Paneli’ne ulaşılabilecek.</strong></p>',
	...
	'INST_ERR_DB_NO_FIREBIRD'		=> 'Bu makinada kurulu olan Firebird 2.1’den daha eski. Lütfen daha yeni bir sürüme yükseltin.',
	...
	'STAGE_CREATE_TABLE'				=> 'Veritabanı tabloları oluşturma',
...
$lang = array_merge($lang, array(
	...
	'SELECT_DOWNLOAD_FORMAT'	=> 'İndirilecek dosyanın arşiv biçimini seçiniz',
	...
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'phpBB sürümünüz güncel değildir.<br />Aşağıda güncellemeyi nasıl yapacağınızı içeren son sürüm duyurusuna bağlantı bulacaksınız.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'phpBB sürümünüz güncel değildir.',
	...
	'VERSION_UP_TO_DATE_ACP'		=> 'phpBB sürümünüz günceldir, phpBB sürümünüz için herhangi bir güncelleme bulunmamaktadır.',
	'VIEWING_FILE_CONTENTS'			=> 'Dosya içeriği görüntüleniyor',
	'VIEWING_FILE_DIFF'				=> 'Dosya farklılıkları görüntüleniyor',

	'WRONG_INFO_FILE_FORMAT'		=> 'Yanlış bilgi dosyası biçimi',
));
