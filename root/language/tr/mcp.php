...
$lang = array_merge($lang, array(
	...
	'ALREADY_REPORTED_PM'	=> 'Bu özel mesaj zaten rapor edilmiş.',
	...
	'CLOSE_PM_REPORT_CONFIRM'	=> 'Seçilen özel mesaj raporunu kapatmak istediğinizden emin misiniz?',
	'CLOSE_PM_REPORTS'			=> 'ÖM raporlarını kapat',
	'CLOSE_PM_REPORTS_CONFIRM'	=> 'Seçilen özel mesaj raporlarını kapatmak istediğinizden emin misiniz?',
	...
	'DELETE_PM_REPORT_CONFIRM'	=> 'Seçilen özel mesaj raporunu silmek istediğinizden emin misiniz?',
	'DELETE_PM_REPORTS'			=> 'ÖM raporlarını sil',
	'DELETE_PM_REPORTS_CONFIRM'	=> 'Seçilen özel mesaj raporlarını silmek istediğinizden emin misiniz?',
	...
	'LATEST_REPORTED_PMS'		=> 'Son 5 özel mesaj raporu',
	...
	'MCP_PM_REPORTS'				=> 'ÖM raporları',
	'MCP_PM_REPORT_DETAILS'			=> 'ÖM rapor detayları',
	'MCP_PM_REPORTS_CLOSED'			=> 'Kapalı ÖM raporlar',
	'MCP_PM_REPORTS_CLOSED_EXPLAIN'	=> 'Bu liste kapalı ve çözüme ulaşan tüm özel mesaj raporlarının bir listesidir.',
	'MCP_PM_REPORTS_OPEN'			=> 'Açık ÖM raporlar',
	'MCP_PM_REPORTS_OPEN_EXPLAIN'	=> 'Bu liste açık ve çözüm bekleyen tüm özel mesaj raporlarının bir listesidir.',

	'MCP_REPORTS'							=> 'Mesaj raporları', // post (ileti) -> message (mesaj) yapılmış ??
	'MCP_REPORT_DETAILS'					=> 'Rapor detayları',
	'MCP_REPORTS_CLOSED'					=> 'Kapalı raporlar',
	'MCP_REPORTS_CLOSED_EXPLAIN'			=> 'Bu liste kapalı ve çözüme ulaşan tüm ileti raporlarının bir listesidir.',
	'MCP_REPORTS_OPEN'						=> 'Açık raporlar',
	'MCP_REPORTS_OPEN_EXPLAIN'				=> 'Bu liste açık ve çözüm bekleyen tüm ileti raporlarının bir listesidir.',
	...
	'PM_REPORT_DELETED_SUCCESS'	=> 'Seçilen özel mesaj raporu silindi.',
	'PM_REPORTED_SUCCESS'		=> 'Özel mesaj rapor edildi.',
	'PM_REPORT_TOTAL'			=> '<strong>1</strong> adet özel mesaj raporu incelenmek için bekliyor.',
	'PM_REPORTS_CLOSED_SUCCESS'	=> 'Seçilen özel mesaj raporları kapatıldı.',
	'PM_REPORTS_DELETED_SUCCESS'=> 'Seçilen özel mesaj raporları silindi.',
	'PM_REPORTS_TOTAL'			=> '<strong>%d</strong> adet özel mesaj raporu incelenmek için bekliyor.',
	'PM_REPORTS_ZERO_TOTAL'		=> 'İncelenmek için bekleyen özel mesaj raporu yok.',
	'PM_REPORT_DETAILS'			=> 'Özel mesaj rapor detayları ',

	'POSTER'					=> 'Gönderen',
	'POSTS_APPROVED_SUCCESS'	=> 'Seçilen iletiler onaylandı.',
	'POSTS_DELETED_SUCCESS'		=> 'Seçilen iletiler veritabanından silindi.',
	'POSTS_DISAPPROVED_SUCCESS'	=> 'Seçilen iletiler kabul edilmedi.',
	...
	'THIS_PM_IP'				=> 'Bu mesaj için IP adresi',
	...
	'VIEW_PM'				=> 'Özel mesaj', // View private message
	'VIEW_POST'				=> 'İleti',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			'WAREZ'		=> 'Mesaj yasal olmayan bir sayfaya veya yazılıma yönlendiriyor.',
			'SPAM'		=> 'Mesaj bir site veya program reklamından başka birşey içermiyor.',
			'OFF_TOPIC'	=> 'Mesaj konu dışı.',
